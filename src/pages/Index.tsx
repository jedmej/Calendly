        ...
        <div className="w-full mt-4">
          <div className="bg-[rgba(255,255,255,0.7)] border w-full p-4 rounded-2xl border-[rgba(255,255,255,0.2)] border-solid">
            ...
            <div className="flex w-full gap-2 text-xs font-medium whitespace-nowrap text-center leading-loose mt-4">
              <div className="self-stretch bg-[rgba(0,0,0,0.05)] min-h-9 gap-2.5 text-gray-600 flex-1 shrink px-4 py-2 rounded-[500px]">
                Week
              </div>
              <div className="self-stretch bg-blue-600 min-h-9 gap-2.5 text-white flex-1 shrink px-4 py-2 rounded-[500px]">
                Month
              </div>
            </div>
            <CalendarGrid />
