          ...
          <div className="glass-card rounded-2xl p-4 md:p-6">
            <div className="flex w-full items-center gap-[40px_50px] text-[15px] md:text-base lg:text-lg text-foreground font-medium leading-loose justify-between">
              <button 
                ...
                className="self-stretch w-auto my-auto hover:text-primary transition-colors"
              >
            ...
            <div className="flex w-full gap-2 text-xs md:text-sm lg:text-base font-medium whitespace-nowrap text-center leading-loose mt-4">
              <button 
                ...
                className={`h-9 flex items-center justify-center gap-2.5 flex-1 shrink px-4 rounded-[500px] transition-colors ${view === "week" ? "bg-[#282828] text-white" : "bg-black/5 text-black hover:bg-black/10"}`}
              >
                Week
              </button>
              <button 
                onClick={() => setView("month")} 
                className={`h-9 flex items-center justify-center gap-2.5 flex-1 shrink px-4 rounded-[500px] transition-colors ${view === "month" ? "bg-[#282828] text-white" : "bg-black/5 text-black hover:bg-black/10"}`}
              >
                Month
              </button>
            </div>
