...
export const EventList: React.FC<EventListProps> = ({ date, events, onDateChange }) => {
  ...
  return (
    <motion.div 
      className="bg-[rgba(255,255,255,0.7)] border w-full mt-4 p-4 rounded-2xl border-[rgba(255,255,255,0.2)] border-solid"
      drag="x"
      dragDirectionLock
