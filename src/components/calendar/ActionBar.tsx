...
export const ActionBar: React.FC = () => {
  ...
  return (
    <div className="bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.05)] border self-center flex w-full max-w-[373px] items-stretch rounded-[500px] border-[rgba(255,255,255,0.2)] border-solid">
